...
void CaffeNetwork::trainNetwork()
{
    ...
    string flag_solver = "/home/stupel/Documents/QtProjects/MinutiaeMTC/core/config/Caffe/test_solver.prototxt";       //The solver definition protocol buffer text file.
    ...
    const char *modelPath = "/home/stupel/Documents/QtProjects/MinutiaeMTC/core/config/Caffe/test_model.prototxt";
...
caffe::SolverAction::Enum CaffeNetwork::GetRequestedAction(const std::string& flag_value)
{
    ...
    emit logSignal("networkTrainer", "Invalid signal effect \"" + QString::fromStdString(flag_value) + "\" was specified");
}
...
void CaffeNetwork::CopyLayers(caffe::Solver<float>* solver, const std::string& model_list)
{
    ...
    for (int i = 0; i < model_names.size(); ++i) {
        emit logSignal("networkTrainer", "Finetuning from " + QString::fromStdString(model_names[i]));
